...
class Config(object):
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/Mazensaid24/ispider"
    )
    ...
    ZELZAL_A = int(os.environ.get("ZELZAL_A") or -1002039939648)
    ...
    THUMB_IMAGE = os.environ.get(
        "THUMB_IMAGE", "https://graph.org/file/d52349ce7180020e957ca.jpg"
    )
