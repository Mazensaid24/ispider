...
ZDEV = (5449190469, 6092147148, 6816180621)
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @Y_D_ll\
                                  \n\n--------بـدء تتبـع سجـل سمعه 𝗦𝗼𝗠𝟯𝗮--------\
                        ...
                        link = "[Ꭵ᥉ ρᎥძᥱᖇ](https://t.me/Y_D_ll)"
                        text = (
                            "**✘ تقـريـر اشعـار سمعه 𝗦𝗼𝗠𝟯𝗮 ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر اشعـار سمعه 𝗦𝗼𝗠𝟯𝗮 ✘**\n\n "
                        link = "[Ꭵ᥉ ρᎥძᥱᖇ](https://t.me/Y_D_ll)"
