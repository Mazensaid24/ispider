...
""" 
CC Checker & Generator for 𝗦𝗼𝗠𝟯𝗮™ t.me/𝗦𝗼𝗠𝟯𝗮
Write file by Zelzal t.me/Y_D_ll
hhh o ya beby
...
async def song2(event):
    ...
    chat = "@SDBB_Bot" # code by t.me/Y_D_ll
...
async def song2(event): # code by t.me/Y_D_ll
...
async def song2(event):
    been = "410039xxxxxxxxxx|xx|xxxx|xxx" # code by t.me/Y_D_ll
    chat = "@SDBB_Bot" # code by t.me/Y_D_ll
    reply_id_ = await reply_id(event)
...
async def song2(event):
    been = "524447000053xxxx|xx|xxxx|xxx" # code by t.me/Y_D_ll
    chat = "@SDBB_Bot" # code by t.me/Y_D_ll
    reply_id_ = await reply_id(event)
...
async def song2(event):
    been = "373352589xxxxxx|xx|xxxx|xxxx" # code by t.me/Y_D_ll
    chat = "@SDBB_Bot" # code by t.me/Y_D_ll
    reply_id_ = await reply_id(event)
