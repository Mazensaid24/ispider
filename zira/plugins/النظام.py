...
async def psu(event):
    ...
    softw = "** 𓆩 𝗦𝗼𝗨𝗿𝗖𝗲 𝗦𝗼𝗠𝟯𝗮 𝑺𝒀𝑺𝑻𝑬𝑴 𝑰𝑵𝑭𝑶 𓆪 **\n"
...
async def cpu(event):
    ...
    await edit_or_reply(
        event, f"**[SOURCE_SOM3A](tg://need_update_for_some_feature/) CPU Model:**\n{o}"
    )
...
async def _(event):
    ...
    if BOTLOG:
        await event.client.send_message(BOTLOG_CHATID, "#إعــادة_التشغيــل\n\n" "**⪼ بـوت سمعه في وضـع اعـادة التشغيـل انتظـر**\n\n" "**⪼ اذ لـم يستجـب البـوت بعـد خمـس دقائـق .. قـم بالذهـاب الـى حسـاب هيـروكو واعـادة التشغيـل اليـدوي**")
    zzz1 = await event.edit(f"ᯓ 𝙎𝙊𝙐𝙍𝘾𝙀 𝗦𝗼𝗠𝟯𝗮 🝢 **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت سمعه . . .🌐**")
    await asyncio.sleep(1)
    zzz2 = await zzz1.edit("ᯓ 𝙎𝙊𝙐𝙍𝘾𝙀 𝗦𝗼𝗠𝟯𝗮 🝢 **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت سمعه . . .🌐**\n\n%𝟷𝟶 ▬▭▭▭▭▭▭▭▭▭")
    await asyncio.sleep(1)
    zzz3 = await zzz2.edit("ᯓ 𝙎𝙊𝙐𝙍𝘾𝙀 𝗦𝗼𝗠𝟯𝗮 🝢 **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت سمعه . . .🌐**\n\n%𝟸𝟶 ▬▬▭▭▭▭▭▭▭▭")
    await asyncio.sleep(1)
    zzz4 = await zzz3.edit("ᯓ 𝙎𝙊𝙐𝙍𝘾𝙀 𝗦𝗼𝗠𝟯𝗮 🝢 **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت سمعه . . .🌐**\n\n%𝟹𝟶 ▬▬▬▭▭▭▭▭▭▭")
    await asyncio.sleep(1)
    zzz5 = await zzz4.edit("ᯓ 𝙎𝙊𝙐𝙍𝘾𝙀 𝗦𝗼𝗠𝟯𝗮 🝢 **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت سمعه . . .🌐**\n\n%𝟺𝟶 ▬▬▬▬▭▭▭▭▭▭")
    await asyncio.sleep(1)
    zzz6 = await zzz5.edit("ᯓ 𝙎𝙊𝙐𝙍𝘾𝙀 𝗦𝗼𝗠𝟯𝗮 🝢 **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت سمعه . . .🌐**\n\n%𝟻𝟶 ▬▬▬▬▬▭▭▭▭▭")
    await asyncio.sleep(1)
    zzz7 = await zzz6.edit("ᯓ 𝙎𝙊𝙐𝙍𝘾𝙀 𝗦𝗼𝗠𝟯𝗮 🝢 **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت سمعه . . .🌐**\n\n%𝟼𝟶 ▬▬▬▬▬▬▭▭▭▭")
    await asyncio.sleep(1)
    zzz8 = await zzz7.edit("ᯓ 𝙎𝙊𝙐𝙍𝘾𝙀 𝗦𝗼𝗠𝟯𝗮 🝢 **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت سمعه . . .🌐**\n\n%𝟽𝟶 ▬▬▬▬▬▬▬▭▭▭")
    await asyncio.sleep(1)
    zzz9 = await zzz8.edit("ᯓ 𝙎𝙊𝙐𝙍𝘾𝙀 𝗦𝗼𝗠𝟯𝗮 🝢 **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت سمعه . . .🌐**\n\n%𝟾𝟶 ▬▬▬▬▬▬▬▬▭▭") 
    await asyncio.sleep(1)
    zzzz10 = await zzz9.edit("ᯓ 𝙎𝙊𝙐𝙍𝘾𝙀 𝗦𝗼𝗠𝟯𝗮 🝢 **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت سمعه . . .🌐**\n\n%𝟿𝟶 ▬▬▬▬▬▬▬▬▬▭") 
    await asyncio.sleep(1)
    zzzz11 = await zzzz10.edit("ᯓ 𝙎𝙊𝙐𝙍𝘾𝙀 𝗦𝗼𝗠𝟯𝗮 🝢 **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت سمعه . . .🌐**\n\n%𝟷𝟶𝟶 ▬▬▬▬▬▬▬▬▬▬💯") 
    sandy = await edit_or_reply(
        zzzz11,
        f"ᯓ 𝙎𝙊𝙐𝙍𝘾𝙀 𝗦𝗼𝗠𝟯𝗮 🝢 **إعــادة التشغيــل**\n"
        f"**•─────────────────•**\n\n"
        f"**•⎆┊اهـلا عـزيـزي** - {mention}\n"
        f"**•⎆┊يتـم الان اعـادة تشغيـل بـوت سمعه**\n"
...
async def _(event):
    cmd = "ls zira/plugins"
    o = (await _zedutils.runcmd(cmd))[0]
    OUTPUT = f"**⌔∮ [𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗼𝗠𝟯𝗮](tg://need_update_for_some_feature/) الالاضافات:**\n{o}"
...
async def _(event):
    ...
    o = stdout.decode()
    OUTPUT = (
        f"**[𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗼𝗠𝟯𝗮](tg://need_update_for_some_feature/) - فـارات تنصيبـك هـي:**\n\n\n{o}"
    )
    if len(OUTPUT) > Config.MAX_MESSAGE_SIZE_LIMIT:
        with io.BytesIO(str.encode(OUTPUT)) as out_file:
            out_file.name = "env.text"
...
async def _(event):
    ...
    stdout, stderr = await process.communicate()
    o = stdout.decode()
    OUTPUT = f"**[ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𝗦𝗼𝗠𝟯𝗮](tg://need_update_for_some_feature/) - سرعـة السيرفـر**\n**- تم حسـاب سرعـة سيرفـر البـوت الخـاص بك :**\n\n{o}"
    if len(OUTPUT) > Config.MAX_MESSAGE_SIZE_LIMIT:
        with io.BytesIO(str.encode(OUTPUT)) as out_file:
            out_file.name = "env.text"
            await event.client.send_file(
...
async def zeddd(event): # Code By T.me/SOURCE_SOM3A
    uname = platform.uname()
    zedt = "**- تاريخ تنصيبـك لـ بـوت سمعه - 𓆩𝙎𝙊𝙐𝙍𝘾𝞝 𝗦𝗼𝗠𝟯𝗮𓆪**\n\n"
    if gvarstatus("z_date") is not None: # Code By T.me/SOURCE_SOM3A
        zzd = gvarstatus("z_date")
        zzt = gvarstatus("z_time")
    else: # Code By T.me/SOURCE_SOM3A
        boot_time_timestamp = psutil.boot_time()
        bt = datetime.fromtimestamp(boot_time_timestamp)
