...
ZelzalPH_cmd = (
    "𓆩 [𝙎𝙊𝙐𝙍𝘾𝙀 𝗦𝗼𝗠𝟯𝗮 📲 - كـاشـف الارقـام العربيــة](t.me/SOURCE_SOM3A) 𓆪\n\n"
    "**⪼ الامــر ↵**\n\n"
...
async def _(event): #Code by T.me/Y_D_ll
    ...
    zelzal = "@ZZIIIbot" #Code by T.me/Y_D_ll
    zed = await edit_or_reply(event, "**⎉╎جـارِ الكشـف عن الرقـم 📲**\n**⎉╎انتظـر قليـلاً ... ▬▭**")
    async with borg.conversation(zelzal) as conv: # code by t.me/Y_D_ll
        try:
