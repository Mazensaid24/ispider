# SOURCE_SOM3A
# Copyright (C) 2023 SOURCE_SOM3A . All Rights Reserved
#
# This file is a part of < https://github.com/Zed-Thon/ZelZal/ >
# PLease read the GNU Affero General Public License in
# <https://www.github.com/SOURCE_SOM3A/Y_D_ll/blob/master/LICENSE/>.
import requests
import asyncio
import os
import sys
...
#الملـف كتابـة سمعه ⤶ @SOURCE_SOM3A خاص بسـورس ⤶ 𝗦𝗼𝗠𝟯𝗮
...
async def linkapk(event):
    ...
    if input_str == "الحذف":
        return
    chat = "@apkdl_bot" # code by t.me/SOURCE_SOM3A
