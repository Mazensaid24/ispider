...
async def amireallyalive(event):
    ...
    ALIVE_TEXT = gvarstatus("ALIVE_TEXT") or "** بـوت  سمعه 𝗦𝗼𝗠𝟯𝗮  يعمـل .. بنجـاح ☑️ 𓆩 **"
...
**{Z_EMOJI} قنـاة السـورس :** [اضغـط هنـا](https://t.me/SOURCE_SOM3A)"""
...
async def amireallyialive(event):
    ...
    reply_to_id = await reply_id(event)
    Z_EMOJI = gvarstatus("ALIVE_EMOJI") or "✥┊"
    zed_caption = "** بـوت  سمعه 𝗦𝗼𝗠𝟯𝗮  يعمـل .. بنجـاح ☑️ 𓆩 **\n"
