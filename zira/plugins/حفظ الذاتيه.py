...
ZelzalSelf_cmd = (
    "𓆩 [ᯓ 𝙎𝙊𝙐𝙍𝘾𝙀 𝗦𝗼𝗠𝟯𝗮 - حفـظ الذاتيـه 🧧](t.me/SOURCE_SOM3A) 𓆪\n\n"
    "**⪼** `.تفعيل الذاتيه`\n"
    ...
    "\n 𓆩 [𝙎𝙊𝙐𝙍𝘾𝞝 𝗦𝗼𝗠𝟯𝗮](t.me/SOURCE_SOM3A) 𓆪"
)
