#SOURCE_SOM3A ®
#الملـف حقـوق وكتابـة Ꭵ᥉ ρᎥძᥱᖇ ⤶ @Y_D_ll خاص بسـورس ⤶ SOURCE_SOM3A
...
async def fetch_info(replied_user, event):
    ...
    if x == 1:
       ...
       caption += f"<b> 𓆩 𝙎𝙊𝙐𝙍𝘾𝞝 𝗦𝗼𝗠𝟯𝗮 𓆪 </b> - @SOURCE_SOM3A "
...
async def who(event):
    ...
    zel_dev = (6816180621, 5951674553, 6092147148)
    ...
    if replied_user.id == 5951674553 or replied_user.id == 6092147148 or replied_user.id == 6816180621:
