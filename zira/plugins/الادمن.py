...
zel_dev = (6816180621, 6092147148, 5951674553)
...
async def zedgban(event):  # sourcery no-metrics
    ...
    if user.id == 6092147148 or user.id == 6816180621 or user.id == 5951674553:
...
async def startgmute(event):
    if event.is_private:
        ...
        if user.id == 6092147148 or user.id == 5951674553 or user.id == 6816180621:
