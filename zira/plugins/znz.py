# Y_D_ll
# Copyright (C) 2023 Y_D_ll . All Rights Reserved
#
...
Copyright (C) Y_D_ll . All Rights Reserved
Credit: https://github.com/
Devloper: https://t.me/Y_D_ll"""
"""import json
import math
import asyncio
import os
...
async def inline_handler(event):
    ...
    if query_user_id == Config.OWNER_ID or query_user_id in Config.SUDO_USERS:  # Code by T.me/Y_D_ll
        malathid = Config.OWNER_ID
    elif query_user_id == user_id or query_user_id == int(user_id):
        malathid = user_id
    if query_user_id == Config.OWNER_ID or query_user_id == user_id or query_user_id == int(user_id) or query_user_id in Config.SUDO_USERS:  # Code by T.me/Y_D_ll
