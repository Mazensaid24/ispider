...
""" 
Logo & Style for SOURCE_SOM3A™ t.me/SOURCE_SOM3A
Write file by Zelzal t.me/SOURCE_SOM3A
...
async def lg1(userevent):
    ...
    if gvarstatus("ZED_FONTS") is None: # code by t.me/SOURCE_SOM3A
        zed_font = await get_font_file(userevent.client, "@SOURCE_SOM3A")
    else:
    ...
    if userevent.reply_to_msg_id:
        ...
        async for i in bot.iter_messages(
            "@SOURCE_SOM3A", filter=InputMessagesFilterPhotos
        ):
            PICS_STR.append(i)
    ...
    if arabic_text: # code by t.me/SOURCE_SOM3A
...
async def lg1(userevent):
    ...
    if not arabic_text: # code by t.me/SOURCE_SOM3A
