...
Zed_Vip = (6816180621, 6092147148, 5449190469)
zchannel = {"@SOURCE_SOM3A"}
...
async def mybot(): #Code by T.me/Y_D_ll
    ...
    try:
        if BOTLOG:
            Config.ZEDUBLOGO = await zedub.tgbot.send_file(
                BOTLOG_CHATID,
                "https://graph.org/file/d52349ce7180020e957ca.jpg",
                caption="**•⎆┊تـم بـدء تشغـيل سـورس سمعه الخاص بك .. بنجاح 🧸♥️**",
                buttons=[(Button.url("𝗦𝗼𝗠𝟯𝗮", "https://t.me/SOURCE_SOM3A"),)],
            )
    except Exception as e:
        LOGS.error(e)
        return None
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        _, groupid = await create_supergroup(
            "كـروب السجـل سمعه", zedub, Config.TG_BOT_USERNAME, descript, photozed
        )
